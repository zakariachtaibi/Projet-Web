...
function addSkill(){
    ...
    if(skill_count<5)
    {
        ...
        var field = 
        `<div class="mb-3">
            <label class="form-label">Nom de compétence</label>
            ...
            <select class="form-select mt-2" name="skill_level${skill_count}">
                ...
                <option value="5">5 - Débutant</option>
            </select>
        </div>`;
        console.log(field);
    ...
    if(education_count<3)
    {
        ...
        <div class="mb-3 d-flex justify-content-between">
            <div>
                ...
                <input type="text" name="from${education_count}" class="form-control" placeholder="Année">
            </div>
            <div>
                <label for="exampleInputEmail1" class="form-label">Jusqu'à</label>
                <input type="text" name="to${education_count}" class="form-control" placeholder="Année">
            </div>
        </div>
        <div class="mb-3">
